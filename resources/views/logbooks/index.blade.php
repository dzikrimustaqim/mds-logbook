...
<div class="space-y-6">
    ...
    <div class="bg-mds-yellow-500 border-6 border-mds-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <a href="{{ route('student.logbooks.create') }}"
               class="bg-mds-green-500 text-white font-black border-6 border-mds-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] px-6 py-3 text-lg hover:bg-mds-green-700 transition active:translate-x-[6px] active:translate-y-[6px] active:shadow-none flex items-center gap-2">
    ...
    <div class="bg-white border-6 border-mds-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-4">
        <form method="GET" action="{{ route('student.logbooks.index') }}" class="flex flex-col md:flex-row gap-3">
            ...
            <a href="{{ route('student.logbooks.index') }}" 
               class="bg-white text-mds-black font-black border-4 border-mds-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] px-6 py-3 hover:bg-red-500 hover:text-white transition active:translate-x-1 active:translate-y-1 active:shadow-none whitespace-nowrap text-center">
                CLEAR
            </a>
            @endif
        </form>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full border-collapse">
                ...
                <tbody>
                        ...
                        <td class="border-4 border-mds-black p-4">
                            <div class="flex items-center justify-center gap-2 flex-wrap">
                                ...
                                <a href="{{ route('student.logbooks.show', $logbook->id) }}"
                                   class="inline-flex items-center gap-1 bg-white text-mds-purple-500 font-black border-4 border-mds-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] px-3 py-2 hover:bg-mds-purple-500 hover:text-white transition active:translate-x-1 active:translate-y-1 active:shadow-none"
                                   title="View Logbook">
                                ...
                                <a href="{{ route('student.logbooks.edit', $logbook->id) }}"
                                   class="inline-flex items-center gap-1 bg-white text-mds-blue-500 font-black border-4 border-mds-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] px-3 py-2 hover:bg-mds-blue-500 hover:text-white transition active:translate-x-1 active:translate-y-1 active:shadow-none"
                                   title="Edit Logbook">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="border-4 border-mds-black p-12 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <p class="text-lg font-bold text-mds-gray-500">
                                    ...
                                    @else
                                        Start by creating your first logbook!
                                    @endif
                                </p>
                                @if(!request('search') && !request('status'))
                                <a href="{{ route('student.logbooks.create') }}"
                                   class="mt-4 bg-mds-green-500 text-white font-black border-6 border-mds-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] px-6 py-3 hover:bg-mds-green-700 transition active:translate-x-[6px] active:translate-y-[6px] active:shadow-none">
